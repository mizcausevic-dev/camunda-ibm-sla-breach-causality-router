...
const requiredPlatforms = ["Camunda","IBM"];
const requiredSignals = ["process timer drift","batch handoff risk","exception queues"];
...
console.log('camunda-ibm-sla-breach-causality-router: validation passed');
